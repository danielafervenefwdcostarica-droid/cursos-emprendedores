...
import { obtenerEstudiantesAPI, eliminarUsuarioAPI, actualizarUsuarioAPI, registrarUsuarioAPI, obtenerCursosAPI, crearCursoAPI, eliminarCursoAPI } from '../services/fetch';
...
const AdminProfile = () => {
  ...
  const cargarDatos = async () => {
    try {
      const dataEstudiantes = await obtenerEstudiantesAPI();
      const dataCursos = await obtenerCursosAPI();
          ...
          <>
            ...
            <div className="stats-grid">
              <div className="glass-card">
                <h3 className="card-title">Estudiantes Activos</h3><p className="card-value" style={{ color: '#28a745' }}>{activos}</p>
              </div>
              <div className="glass-card">
                <h3 className="card-title">Estudiantes Inactivos</h3><p className="card-value" style={{ color: '#dc3545' }}>{inactivos}</p>
              </div>
              <div className="glass-card">
                <h3 className="card-title">Cursos Creados</h3><p className="card-value" style={{ color: '#004aad' }}>{cursos.length}</p>
              </div>
            </div>
          </>
        );
